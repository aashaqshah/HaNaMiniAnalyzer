  ...
  isSignalStudy(iConfig.getParameter<bool>( "isSignalStudy" ))
{
  if( !IsData ){
    ...
    if(MuonID == 1 ) // Loose ID
      ...
      hMuSFID = (TH2*)( f1->Get("NUM_MediumPromptID_DEN_TrackerMuons_pt_abseta")->Clone("MuSFID") );
    else if(MuonID == 7 ) // TrkHighPt ID
      //hMuSFID = (TH2*)( f1->Get("MC_NUM_TrkHighPtID_DEN_genTracks_PAR_pt_eta/pt_abseta_ratio")->Clone("MuSFID") );
      hMuSFID = (TH2*)( f1->Get("NUM_TrkHighPtID_DEN_TrackerMuons_pair_newTuneP_probe_pt_abseta")->Clone("MuSFID") );
    else
    ...
    if( MuonIsoCut == 0.25 && MuonID == 1)
      ...
      hMuSFIso = (TH2*)( f1->Get("NUM_LooseRelTkIso_DEN_TrkHighPtID_pair_newTuneP_probe_pt_abseta")->Clone("MuSFIso") );
    else if( MuonIsoCut == 0.05 && MuonID == 7 )
      //hMuSFIso = (TH2*)( f1->Get("NUM_TightRelTkIso_DEN_TrkHighPtID/pt_abseta_ratio")->Clone("MuSFIso") );
      hMuSFIso = (TH2*)( f1->Get("NUM_TightRelTkIso_DEN_TrkHighPtID_pair_newTuneP_probe_pt_abseta")->Clone("MuSFIso") );
