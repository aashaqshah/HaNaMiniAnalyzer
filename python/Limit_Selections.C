...
TH1D *Mu1_s25_Pt_LL = (TH1D*)MyFile->Get("PreselectionLL/Mu1/ExpLimits/ROC_PreselectionLL_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_LL = (TH1D*)MyFile->Get("PreselectionLL/Mu1/ExpLimits/ROC_PreselectionLL_Mu1Pt_Signal50_ExpLimit");
TH1D *Mu1_s25_Pt_ML = (TH1D*)MyFile->Get("PreselectionML/Mu1/ExpLimits/ROC_PreselectionML_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_ML = (TH1D*)MyFile->Get("PreselectionML/Mu1/ExpLimits/ROC_PreselectionML_Mu1Pt_Signal50_ExpLimit");
TH1D *Mu1_s25_Pt_TL = (TH1D*)MyFile->Get("PreselectionTL/Mu1/ExpLimits/ROC_PreselectionTL_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_TL = (TH1D*)MyFile->Get("PreselectionTL/Mu1/ExpLimits/ROC_PreselectionTL_Mu1Pt_Signal50_ExpLimit");
TH1D *Mu1_s25_Pt_MM = (TH1D*)MyFile->Get("PreselectionMM/Mu1/ExpLimits/ROC_PreselectionMM_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_MM = (TH1D*)MyFile->Get("PreselectionMM/Mu1/ExpLimits/ROC_PreselectionMM_Mu1Pt_Signal50_ExpLimit");
TH1D *Mu1_s25_Pt_TM = (TH1D*)MyFile->Get("PreselectionTM/Mu1/ExpLimits/ROC_PreselectionTM_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_TM = (TH1D*)MyFile->Get("PreselectionTM/Mu1/ExpLimits/ROC_PreselectionTM_Mu1Pt_Signal50_ExpLimit");
TH1D *Mu1_s25_Pt_TT = (TH1D*)MyFile->Get("PreselectionTT/Mu1/ExpLimits/ROC_PreselectionTT_Mu1Pt_Signal25_ExpLimit");
TH1D *Mu1_s50_Pt_TT = (TH1D*)MyFile->Get("PreselectionTT/Mu1/ExpLimits/ROC_PreselectionTT_Mu1Pt_Signal50_ExpLimit");
//TDirectory *dir2 = MyFile->GetDirectory("PreselectionLL/Mu2/Significances/SoSqrtB");
//dir->cd();
//gDirectory->pwd();

//Mu1_s25_Pt_LL->GetYaxis()->SetTitle("Expected Limit");
...
cout <<"Exp. Limit for LL "<<bin_cont_25_LL<<endl;
cout <<"Exp. Limit for ML "<<bin_cont_25_ML<<endl;
cout <<"Exp. Limit for TL "<<bin_cont_25_TL<<endl;
cout <<"Exp. Limit for MM "<<bin_cont_25_MM<<endl;
cout <<"Exp. Limit for TM "<<bin_cont_25_TM<<endl;
cout <<"Exp. Limit for TT "<<bin_cont_25_TT<<endl;
...
myHist_25->GetYaxis()->SetTitle("Expected Limit");
...
myHist_25->SetMinimum( 0.98);
myHist_25->SetMaximum(1.00);
myHist_25->Draw();
myHist_50->Draw("SAME");
//Mu1_s25_Pt_LL->Draw();
...
//gStyle->SetLegendBorderSize(0);
   TLegend *leg = new TLegend(0.1845966,0.7062147,0.3520782,0.8531073,NULL,"brNDC");
  ...
  // TLegend *leg = new TLegend(0.7102689,0.7033898,0.8777506,0.8502825,NULL,"brNDC");
   ...
   leg->Draw();
   c1->Modified();
   c1->SaveAs("Expected_Limit_Sel.png");
